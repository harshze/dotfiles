...
alias pushi3='cp ~/.config/i3/config ~/github/dotfiles/i3/i3-config'alias pushalacritty='cp ~/.config/alacritty/alacritty.toml ~/github/dotfiles/alacritty/alacritty.toml'
